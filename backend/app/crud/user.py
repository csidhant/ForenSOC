...
class UserCRUD:
    ...
    @staticmethod
    def get_all_users(db: Session, skip: int = 0, limit: int = 10, active_only: bool = False) -> List[User]:
    ...
    @staticmethod
    def create_user(db: Session, username: str, email: str, password: str, role_id: int) -> User:
        """Create a new user."""
        # Hash password
    ...
    @staticmethod
    def verify_password_and_get_user(db: Session, username: str, password: str) -> Optional[User]:
