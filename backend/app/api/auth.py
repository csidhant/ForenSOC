...
async def login(
    ...
    user = UserCRUD.verify_password_and_get_user(db, credentials.username, credentials.password)
...
@router.post("/register", response_model=UserWithRole, status_code=status.HTTP_201_CREATED)
async def register(
