...
class MitreMapping(BaseModel):
    ...
    # MITRE information
    tactic = Column(String(100), nullable=False)  # 'Reconnaissance', 'Resource Development', 'Initial Access', etc.
    technique = Column(String(100), nullable=False)
    technique_id = Column(String(20), nullable=False, index=True)  # 'T1110', 'T1046', etc.
    ...
    # Relationships
    alert = relationship("Alert", foreign_keys=[alert_id], back_populates="mitre_mappings")
