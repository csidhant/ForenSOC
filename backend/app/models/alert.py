...
class Alert(BaseModel):
    ...
    )  # 'New', 'In Progress', 'Investigating', 'Closed', 'False Positive'
    alert_type = Column(
        String(100)
    )  # 'SSH Brute Force', 'Port Scan', 'Ransomware', etc.
    ...
    creator = relationship(
        "User", foreign_keys=[created_by], back_populates="created_alerts"
    )
    ...
    mitre_mappings = relationship(
        "MitreMapping",
        foreign_keys="MitreMapping.alert_id",
