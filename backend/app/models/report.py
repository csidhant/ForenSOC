...
class Report(BaseModel):
    ...
    # Report info
    report_type = Column(
        String(50), default="Incident Report"
    )  # 'Incident Report', 'Forensic Analysis', 'Timeline Report', etc.
    ...
    )  # 'Generating', 'Generated', 'Reviewed', 'Finalized', 'Archived'
    ...
    generator = relationship(
        "User", foreign_keys=[generated_by], back_populates="generated_reports"
    )
