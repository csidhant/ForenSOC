...
class DetectionRule(BaseModel):
    ...
    rule_type = Column(String(100), nullable=False, index=True)  # 'ssh_brute_force', 'port_scan', etc.
    
    # Detection logic
    pattern = Column(JSON, nullable=False)  # JSON structure defining the detection pattern
    ...
    time_window_seconds = Column(Integer, default=300, nullable=False)  # Time window for threshold
