...
class EvidenceBase(BaseModel):
    ...
    evidence_id: Optional[str] = Field(None, description="Unique evidence identifier (auto-generated)")
    case_id: int = Field(..., description="Associated case ID")
    evidence_type: str = Field(..., description="Type of evidence (PCAP, Memory Dump, Log File, etc.)")
    ...
    integrity_status: Optional[str] = Field("Pending Verification", description="Integrity status")
    collected_date: Optional[datetime] = Field(None, description="When evidence was collected")
